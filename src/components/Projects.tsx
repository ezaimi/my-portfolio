  ...
  return (
    <div className="w-full z-0">
      ...
      <div className="flex flex-col items-center text-center z-0">
        <div className="font-mono text-[#0e0e0e]  text-[18px]">Projects</div>
                  ...
                  >
                    {getPageItems(index).map((item: any, itemIndex: number) => (
                      ...
                      >
                        <div className="sm:p-8">
                          ...
                          style={{
                       ...
                       }} className="shadow-neumorphic px-4 rounded--2xl pt-8 pb-1 rounded-2xl ">
                            ...
                            <div className="px-2 py-3 font-bold text-[18px] tracking-wide bg-gradient-to-r from-[#a367bf] to-[#667ec5] text-transparent bg-clip-text">
                              {item.description}
                            </div>
                            <div className="px-2 pb-3 text-[#303031]">
                              {item.details}
                            </div>
